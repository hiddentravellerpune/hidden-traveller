...
// =======================================================================================
export default function VaranasiAyodhyaPage() {
  ...
  const tabContent = {
    overview: (
      <div className="space-y-4 text-gray-600 leading-relaxed">
        ...
        <p>From the sacred ghats of Varanasi to the divine aura of Ram Mandir in Ayodhya, every step is about culture, spirituality, and hidden stories. Walk through ancient temples, vibrant ghats, narrow alleys, and food trails… feel the rhythm of the Ganga Aarti, and discover the timeless energy of Banaras.</p>
        <p>Later, journey to Ayodhya, the birthplace of Lord Ram, where devotion blends with heritage. Explore sacred ghats, visit temples, taste authentic street food, and soak in the calm of this historic city.</p>
        <p>Expect temples, ghats, culture, food, and heritage — all woven into one epic backpacking adventure!</p>
      </div>
    ),
    itinerary: (
      <div className="space-y-6 text-gray-600">
        <div className="relative border-l-2 border-teal-500 pl-6">
          ...
          <h3 className="text-xl font-bold text-gray-800">DAY 1: DEPARTURE FROM PUNE (FRIDAY)</h3>
          <ul className="list-disc list-inside space-y-1 mt-2">
            <li>TRAIN: PUNE → LOKMANYA TILAK TERMINUS (LLT)</li>
            <li>TRAIN: LLT → PRAYAGRAJ (DURONTO EXPRESS – 3AC)</li>
            <li>OVERNIGHT TRAIN JOURNEY</li>
          </ul>
        </div>
        <div className="relative border-l-2 border-teal-500 pl-6">
          <div className="absolute -left-3 top-1 w-5 h-5 bg-teal-500 rounded-full border-4 border-white"></div>
          <h3 className="text-xl font-bold text-gray-800">DAY 2: ARRIVAL IN PRAYAGRAJ | PRAYAGRAJ TO VARANASI (SATURDAY)</h3>
          <ul className="list-disc list-inside space-y-1 mt-2">
            <li>12:40 PM – ARRIVE AT PRAYAGRAJ</li>
            <li>VISIT TRIVENI SANGAM</li>
            <li>VISIT SHRI BADE HANUMAN JI MANDIR</li>
            <li>LUNCH AT PRAYAGRAJ</li>
            <li>TRAVEL TO VARANASI (BY TRAIN/BUS)</li>
            <li>CHECK-IN AT HOMESTAY/HOTEL</li>
            <li>DINNER</li>
            <li>EVENING: VISIT MANIKARNIKA GHAT</li>
          </ul>
        </div>
        <div className="relative border-l-2 border-teal-500 pl-6">
          <div className="absolute -left-3 top-1 w-5 h-5 bg-teal-500 rounded-full border-4 border-white"></div>
          <h3 className="text-xl font-bold text-gray-800">DAY 3: VARANASI TEMPLES & GHATS (SUNDAY)</h3>
          <ul className="list-disc list-inside space-y-1 mt-2">
            <li>MORNING: VISIT KAL BHAIRAV MANDIR</li>
            <li>BREAKFAST</li>
            <li>VISIT KASHI VISHWANATH MANDIR</li>
            <li>VISIT ANNAPURNA TEMPLE</li>
            <li>LUNCH BREAK</li>
            <li>EVENING: DASHASHWAMEDH GHAT FOR GANGA AARTI</li>
            <li>DINNER & OVERNIGHT STAY</li>
          </ul>
        </div>
        <div className="relative border-l-2 border-teal-500 pl-6">
          <div className="absolute -left-3 top-1 w-5 h-5 bg-teal-500 rounded-full border-4 border-white"></div>
          <h3 className="text-xl font-bold text-gray-800">DAY 4: VARANASI → AYODHYA (MONDAY)</h3>
          <ul className="list-disc list-inside space-y-1 mt-2">
            <li>EARLY MORNING: ASSI GHAT AARTI</li>
            <li>SUNRISE BOAT RIDE ON GANGA</li>
            <li>BREAKFAST</li>
            <li>EXPLORE GHATS & LOCAL STREETS</li>
            <li>CHECK-OUT & TRAVEL TO AYODHYA</li>
            <li>EVENING: CHECK-IN & STAY AT AYODHYA</li>
          </ul>
        </div>
        <div className="relative border-l-2 border-teal-500 pl-6">
          <div className="absolute -left-3 top-1 w-5 h-5 bg-teal-500 rounded-full border-4 border-white"></div>
          <h3 className="text-xl font-bold text-gray-800">DAY 5: AYODHYA → LUCKNOW (TUESDAY)</h3>
          <ul className="list-disc list-inside space-y-1 mt-2">
            <li>BREAKFAST</li>
            <li>VISIT SHRI HANUMAN GARHI MANDIR</li>
            <li>VISIT SHREE RAM JANMABHOOMI TEMPLE</li>
            <li>LUNCH</li>
            <li>CHECK-OUT FROM STAY</li>
            <li>TRAVEL TO LUCKNOW (BY BUS)</li>
            <li>DINNER & OVERNIGHT STAY</li>
          </ul>
        </div>
        <div className="relative border-l-2 border-teal-500 pl-6">
          <div className="absolute -left-3 top-1 w-5 h-5 bg-teal-500 rounded-full border-4 border-white"></div>
          <h3 className="text-xl font-bold text-gray-800">DAY 6: LUCKNOW EXPLORING (WEDNESDAY)</h3>
          <ul className="list-disc list-inside space-y-1 mt-2">
            <li>BREAKFAST</li>
            <li>LOCAL SHOPPING (LUCKNOWI CRAFTS, CHIKANKARI)</li>
            <li>EXPLORE LUCKNOW CITY HIGHLIGHTS:</li>
            <li>CLOCK TOWER</li>
            <li>THE RESIDENCY</li>
            <li>HANUMANT DHAM</li>
            <li>EXPLORE LUCKNOW MONUMENTS & FOOD JOINTS</li>
            <li>LUNCH</li>
            <li>OVERNIGHT STAY IN LUCKNOW</li>
          </ul>
        </div>
        <div className="relative border-l-2 border-teal-500 pl-6">
          <div className="absolute -left-3 top-1 w-5 h-5 bg-teal-500 rounded-full border-4 border-white"></div>
          <h3 className="text-xl font-bold text-gray-800">DAY 7: LUCKNOW → KALYAN BY TRAIN (THURSDAY)</h3>
          <ul className="list-disc list-inside space-y-1 mt-2">
            <li>MORNING CHECK-OUT</li>
            <li>FREE TIME / LOCAL EXPLORATION / LUNCH</li>
            <li>2:00 PM: TRAIN LUCKNOW → KALYAN (GKP–PNVL EXPRESS – 3AC)</li>
            <li>OVERNIGHT TRAIN JOURNEY</li>
          </ul>
        </div>
        <div className="relative border-l-2 border-transparent pl-6">
          <div className="absolute -left-3 top-1 w-5 h-5 bg-teal-500 rounded-full border-4 border-white"></div>
          <h3 className="text-xl font-bold text-gray-800">DAY 8: LUCKNOW → KALYAN BY TRAIN (FRIDAY)</h3>
          <ul className="list-disc list-inside space-y-1 mt-2">
            <li>ARRIVAL AT KALYAN BY 3.00 PM</li>
            <li>CONTINUE TRAIN JOURNEY BACK TO PUNE</li>
            <li>TRIP ENDS WITH MEMORIES! ✨</li>
          </ul>
        </div>
      </div>
    ),
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <ul className="space-y-2 text-gray-600">
            ...
            <li className="flex items-start"><CheckCircle className="text-green-500 mr-2 mt-1 flex-shrink-0" size={20} /> 5 BREAKFAST + 5 LUNCH</li>
            <li className="flex items-start"><CheckCircle className="text-green-500 mr-2 mt-1 flex-shrink-0" size={20} /> VIP DARSHAN</li>
    ...
    datesCost: (
      <div className="space-y-6 text-gray-600 leading-relaxed">
        <div>
          ...
          <p><strong>REGULAR PRICE:</strong> ₹16,499/- PER PERSON</p>
          <p><strong>HIDDEN MEMBER PRICE:</strong> ₹16,000/- PER PERSON</p>
        </div>
        <div>
          ...
          <ul className="list-disc list-inside ml-4 space-y-2">
            ...
            <li><strong>BOOKING ADVANCE:</strong> ₹8,000/- (NON-REFUNDABLE)</li>
    ...
    tc: (
      <div className="space-y-4 text-gray-600 leading-relaxed">
        <p><strong>TERMS & CONDITIONS – HIDDEN TRAVELLER</strong></p>
    ...
    faq: (
      <div className="space-y-4">
        ...
        <FaqItem question="What is the travel style for this trip?" answer="This is a backpacking experience, not a luxury trip. The focus is on authentic local experiences and offbeat exploration with basic comfort." />
  ...
  return (
    <section className="container mx-auto p-4 md:p-8 grid grid-cols-1 lg:grid-cols-3 gap-8 relative z-10">
      <div className="lg:col-span-2 bg-white rounded-2xl shadow-xl p-6 md:p-8">
        <h2 className="text-4xl font-bold mb-6">Varanasi & Ayodhya Backpacking Trip</h2>
      ...
      <div className="lg:col-span-1 space-y-6">
        <div className="bg-gradient-to-br from-teal-500 to-cyan-600 text-white rounded-2xl shadow-xl p-6">
          ...
          <ul className="space-y-4 text-lg">
            <li className="flex items-center"><MapPin className="mr-3" /> Varanasi & Ayodhya</li>
            <li className="flex items-center"><Clock className="mr-3" /> 8 Days / 7 Nights</li>
            <li className="flex items-center"><Users className="mr-3" /> Invitation-Only Batch</li>
            <li className="flex items-center text-2xl font-bold"><IndianRupee className="mr-2" /> 16,499/-</li>
          </ul>
